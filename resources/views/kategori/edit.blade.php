                ...
                <div class="card-body p-4">
                    <form action="{{ route('kategori.update', $kategori->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('ket_kategori') is-invalid @enderror" id="ket_kategori" type="text" name="ket_kategori" value="{{ old('ket_kategori', $kategori->ket_kategori) }}" placeholder="Contoh: Fasilitas Kelas">
                            @error('ket_kategori')
