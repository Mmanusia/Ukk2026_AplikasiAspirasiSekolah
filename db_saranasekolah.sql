...
(4, '2026_04_07_012056_add_two_factor_columns_to_users_table', 1),
(5, '2026_04_07_012958_create_kategoris_table', 1),
(6, '2026_04_07_013004_create_aspirasis_table', 1),
(7, '2026_04_07_013030_create_input_aspirasis_table', 1);
...
ALTER TABLE `input_aspirasis`
  ADD PRIMARY KEY (`id`),
  ADD KEY `input_aspirasis_user_id_foreign` (`user_id`),
  ADD KEY `input_aspirasis_kategori_id_foreign` (`kategori_id`),
  ADD KEY `input_aspirasis_aspirasi_id_foreign` (`aspirasi_id`);
...
--
ALTER TABLE `input_aspirasis`
  ADD CONSTRAINT `input_aspirasis_aspirasi_id_foreign` FOREIGN KEY (`aspirasi_id`) REFERENCES `aspirasis` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `input_aspirasis_kategori_id_foreign` FOREIGN KEY (`kategori_id`) REFERENCES `kategoris` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `input_aspirasis_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;
